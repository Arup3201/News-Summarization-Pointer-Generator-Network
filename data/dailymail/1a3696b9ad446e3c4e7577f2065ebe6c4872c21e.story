...
Late on the bandwagon? Microsoft has launched a device called 'Microsoft Band' (pictured) that will allow users to monitor their fitness and exercise regime. now it is believed to be working on an Xbox version.
...
Fitbit and rival exercise bands have been around for a few years, but the world's largest
software company's has only now made its debut into the wearable technology market, launching an exercise band, smartwatch hybrid.
...
The wrist-worn device has 10 smart sensors that monitor pulse rate,
measure calorie burn and track sleep quality, Microsoft said in
a blog post.
...
The device also offers workouts put together by Men's Health, for example, and GPS route mapping so users can see where they have ran or cycled.
...
Appearance: The band is primarily made of rubber and features a sleek colour touchscreen. Users can change the background screen's colour and design.

Sensors: It has 10 sensors that monitor everything from heart rate and sleep to UV, prompting wearers to apply sunscreen.

Price: $199.

Availability: US only from today. UK prices and availability haven't been announced yet.
...
The device is designed to work alongside iPhone, Android and Windows Phone handsets, and will be available in the United
States from today for $199. UK availability and pricing has yet to be announced.
...
Microsoft also launched a health app called 'Microsoft
Health' that includes a cloud service for users to store and
combine health and fitness data. 

The  app will collect data from the fitness
band and will work on iPhones and Android smartphones, as well
...
Fitbit has revealed a trio of new trackers this week - including a $250 smartwatch, which it hopes can take on the Apple Watch.

Called Surge, the watch has GPS, heart rate monitoring and smartwatch functionality. The firm has also added a heart rate monitor to its traditional tracing wristband, now called the chargeHR.
...
Fitbit's new range: The $129 Fitbit charge, the $149 chargeHR (pictured) have a heart rate sensors, and the $249 Surge comes with GPS, heart rate monitoring and smartwatch functionality

'Continuing our mission to inspire people to lead healthier, more active lives, we're releasing these three new innovative devices to help reach everyday, active or performance health and fitness goals,' the San Francisco firm says.

The Surge watch will put the firm on a collision course with Apple - and now Microsoft.
