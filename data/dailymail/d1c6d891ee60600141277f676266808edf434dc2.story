Apple offers a range of ways to unlock its devices from PINs to passwords and fingerprints. 
...
Android Lollipop users already have an almost identical feature known as 'Trusted face' (left) in the Smart Lock menu. Once the screen is enabled and the camera is held in front of the face, the screen automatically unlocks. The face icon between the Whatsapp and Chrome logo (right) shows the feature is enabled
