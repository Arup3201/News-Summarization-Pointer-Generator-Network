Finding your lost Android phone is now as simple as searching for a nearby restaurant or transport route. 
...
Install the latest Google Android app. 
...
Google's latest tool can't lock the missing phone, or erase its data and users will need to install the Android Device Manager (ADM) app if they want these features.  

Both tools override the selected sound profile meaning that even if a phone is on silent it will still ring at full volume for five minutes.
