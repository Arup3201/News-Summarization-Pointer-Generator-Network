A flying saucer took to the skies over Hawaii on Saturday as Nasa tested a new vehicle that could one day be used to transport people to Mars.
...
The Low-Density Supersonic Decelerator (LDSD), landed off the coast of the U.S. Navy's Pacific Missile Range Facility in Kauai, Hawaii after being dropped from a balloon 120,000 feet over the Pacific Ocean at the time of the drop.

The low-density supersonic decelerator could one day be used to take astronauts to Mars, and is shown here before the test
...
Imagery downlinked in real-time from the test vehicle indicates that the parachute did not deploy as expected, and the team is still analyzing data on the parachute so that lessons learned can be applied for the next test flights, scheduled for early next year.

'We are thrilled about the test,' said Mark Adler, project manager for LDSD at NASA's Jet Propulsion Laboratory in Pasadena, California.

'The test vehicle worked beautifully, and we met all of our flight objectives.
...
The test vehicle hardware, black box data recorder and parachute were all recovered later in the day after the craft was dragged aboard a Nasa ship

A graphic shows the proposed flight path and touch down for the flying saucer mission
...
The vehicle splashed down in the ocean at approximately 11:35 a.m. HST (2:35 p.m. PDT/5:35 p.m. EDT), after the engineering test flight concluded. The test vehicle hardware, black box data recorder and parachute were all recovered later in the day.
...
'This entire effort was just fantastic work by the whole team and is a proud moment for Nasa's Space Technology Mission Directorate," said Dorothy Rasco, deputy associate administrator for the Space Technology Mission Directorate at Nasa Headquarters in Washington.

'This flight reminds us why NASA takes on hard technical problems, and why we test - to learn and build the tools we will need for the future of space exploration.

'Technology drives exploration, and yesterday's flight is a perfect example of the type of technologies we are developing to explore our solar system.'
