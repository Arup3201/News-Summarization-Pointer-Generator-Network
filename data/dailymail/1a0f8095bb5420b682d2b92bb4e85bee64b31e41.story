...
The U.S. spends $4billion (£2.7billion) a year on unnecessary medical costs due to mammograms generating false alarms and on treatment for breast tumors unlikely to cause problems, a new report has revealed.
...
Annual mammograms starting at 40 years old have long been considered standard for preventive care, because cancer is easier to treat if detected early. But recently there has been disagreement about regular screening for women in their 40s.

Study authors Mei-Sing Ong, a research fellow at Boston Children's Hospital, and Kenneth Mandl, a professor at Harvard Medical School, say their findings indicate that the cost of breast cancer overtreatment appears to be much higher than previously estimated. 
...
'The two messages together are powerful. The fact that this is not only a problem, but a very costly problem we hope will accelerate the attempts to try to fix the screening practices.'

But another expert defended those practices, and called the study one-sided.

'There was no attempt to balance the costs with the benefits,' said Richard Wender, who heads prevention, detection and patient-support efforts at the American Cancer Society. 
...
Early detection: Annual mammograms starting at 40 years old have long been considered standard for preventive care, because cancer is easier to treat if detected early

The American Cancer Society recommends yearly mammograms for women starting at 40, while a government advisory group says regular screening should begin at 50
...
The study was based on billing data from a major U.S. insurer, including more than 700,000 women aged between 40 and 59 in all 50 states, from 2011 through 2013.

The U.S. spends much more on healthcare than any other country, but lags behind other economically advanced societies on life expectancy and certain other health indicators. 
...
Study estimates yearly figure for women aged 40-59
