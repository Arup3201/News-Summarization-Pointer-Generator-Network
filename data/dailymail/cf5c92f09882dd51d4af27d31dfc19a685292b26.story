...
The orchid (an example of which is pictured) has evolved a so-called lip - a large and irregular modified petal, to attract insects - but the driving force behind this unusual shape was not known, until now

The study, published in the journal Nature Plants, extends scientists' understanding of the mechanisms leading to the diverse beauty of orchid flowers.
...
They also have three sepals, which sometimes look like other petals, and a single column at the centre which is used during reproduction. 

Researchers have found its shape is determined by two competing groups of proteins. They converted lips into petals in two orchid species by reducing the activity of the L complex using gene silencing (illustrated)

Conversion of lips into sepal/petal-like structures in Oncidium and Phalaenopsis orchids is shown

Orchids have three sepals, which sometimes look like other petals, and a single column at the centre.

Lips attract insect pollinators and serve as a landing platform for them, which is thought to have given orchids an evolutionary advantage over other flowers, by promoting reproduction.
...
The have called this mechanism the Perianth code and discovered that orchid species from many subfamilies with different types of lips and petals all obey it.
...
Lips are differently coloured, ruffled or pouch-shaped, depending on the species, and can be decorated with horns, hairs, warts, teeth and tails to attract specific pollinators.

These range from bees to flies, gnats, moths, butterflies, hummingbirds and even bats in some tropical climates.
...
The scientists studied the expression of a class of genes known to be associated with petal development. They found that in mature orchid flowers,  two protein complexes, called the 'L' complex (red) and the 'SP' complex (blue), compete to form the lip and petals. This competition and balancing act is illustrated above
...
But earlier this year, scientists suggested that the mantis doesn't simply blend into flowers, but is attractive to insects in its own right, sometimes preferring to remain more easily visible on leaves.

It was popularly thought that the orchid mantis (pictured), whose legs are flattened and heart-shaped to resemble petals, simply mimics an orchid, allowing it to 'hide' and catch prey
...
When paired alongside the most common flower in their habitat, insects approached mantises more often than flowers, showing that mantises are attractive to insects by themselves, rather than simply camouflaging among the flora. Here, an orchid mantis eats a Tiger heliconian butterfly in Malaysia

They also found that mantises did not choose to hide among the flowers, but selected leaves to sit on, just as often.
...
They may exploit a loophole created by evolutionary efficiency savings within the insect brain.
