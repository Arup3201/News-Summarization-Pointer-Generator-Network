...
The credit card-sized gadget also locks devices again as soon as a user moves out of range at a distance of ten feet (three metres).
...
The card was created by Illinois-based duo Joel Paglione and Niko Zistakis..
...
'Recent mobile phones integrate fingerprint scanners to authenticate users biometrically and replace passwords, making authentication more convenient for users,' explained the researchers. 

'However, due to their cost, capacitive fingerprint scanners have been limited to top-of-the-line phones, a result of the required resolution and quality of the sensor.' 

They continued that while the input resolution of a touchscreen is around six dots per inch (dpi) - meaning it can't capture the level of detail in a fingerprint - the surface area is larger than a more advanced reader. 

This allows the touch sensor 'to scan users’ body parts, such as ears, fingers, fists, and palms by pressing them against the display.'
...
This accuracy was highest when scanning the ear due to its more unique shape and size.

It’s not just ears that could be used for identification – your first, phalanges (in your fingers), palm or just your fingertips could also be used (shown). This means that just gripping the phone could unlock it for you

A video demonstrating the technology revealed Bioprint can also be used to add multiple users to a single device.

So, for example, if something required dual identification then both people could provide it. 

It’s not just ears that could be used for identification - your fist, phalanges (in your fingers), palm or your fingertips could also be used.

This means that just gripping the phone could unlock it for you.

There's no news yet on when the feature might be made available to manufacturers, but the team says their next step is to continue testing.

To accept an incoming call, users would only need to press their ear against the phone (example shown). During tests with 12 participants, Bodyprint classified body parts with 99.98 per cent accuracy and identified users with 99.52 per cent accuracy
