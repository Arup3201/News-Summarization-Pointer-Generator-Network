It may sound like the stuff of science fiction, but this stunning image shows that a white dwarf star  ripped apart a planet as it came too close.
...
For example, the gravity at the surface of a white dwarf is over ten thousand times higher than the gravity at the surface of the Sun.
...
'A planet is first pulled away from its parent star by the gravity of the dense concentration of stars in a globular cluster,' the experts write.
...
NGC 6388 in the X-ray spectrum. Chandra's excellent X-ray vision enabled the astronomers to determine that the X-rays from NGC 6388 were not coming from the putative black hole at the center of the cluster, but instead from a location slightly off to one side.

Optical observations had hinted that an intermediate-mass black hole with mass equal to several hundred Suns or more resides at the center of NGC 6388.  
...
The source was monitored with the X-ray telescope on board NASA's Swift Gamma Ray Burst mission for about 200 days after the discovery by INTEGRAL.
...
While the case for the tidal disruption of a planet is not iron-clad, the argument for it was strengthened when astronomers used data from the multiple telescopes to help eliminate other possible explanations for the detected X-rays. 
...
Also, the source is much too faint in radio waves to be part of a binary system with a stellar-mass black hole.
