...
ASD Sonnenspeicher uses a lithium iron phosphate battery to store the energy harvested during the day by solar panels. 

This energy is used throughout the day, and any excess is stored for when the sun sets.

Rather than selling this excess electricity to the grid, and potentially having to buy it back at a later date or time, homeowners can use this stored supply to power their home until the sun rises again. 

Sonnenspeicher features an intelligent management system that automatically controls the charging and discharging current, to make it easier to manage how much energy is being used.

It additionally has a Sleep mode that ensures that the storage system never runs low and will automatically go into standby when its not being used to increase efficiency. 
...
The firm said an average home can save around €1,200 a year (£876), so it would still take around seven years to recoup the costs, but the system will last for 20 years. 
