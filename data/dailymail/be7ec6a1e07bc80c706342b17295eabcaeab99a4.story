Sending dozens of messages or playing games for hours can cause your phone to overheat, which can drain battery and even damage the device. 
...
Optimal's sensors are pictured. When Optimal's air vents are blocked, for example when the phone is in a pocket or bag, it will alert the user to warn them the temperature in their phone needs to be corrected. Alternatively, the phone can use Optimal's built-in battery as a backup

Optimal is fitted with temperature sensors, resistance coils and two 2mm micro-fans.

It syncs with a smartphone over Bluetooth and constantly analyses the phone's temperature when in Auto mode. 

If it gets too hot, Optimal will cool the device using the micro-fans. These fans help the phone dissipate heat faster and cools down the device.
...
Optimal remains in low-power, 'sleeping mode' the rest of the time to conserve battery. 
...
Studies have found that a phone is most efficient between 0° and 35°C (32°F to 95°F), and keeping it as near room temperature as possible (22° C or 72°F ) is ideal.

At an average temperature of 0°C (32°F), a lithium-ion battery will lose 6% of its maximum capacity every year. At 25°C (77°F) degrees that number jumps to 20%.

Batteries exposed to hot temperatures lose their ability to store energy and the hotter the temperature, the faster they lose this ability.

Extreme heatcan also cause permanent battery failure if exposed for long periods.

In the cold, when the temperatures drop low enough, the phone could think its battery is empty even if it’s fully charged.

The colder it gets, the least amount of energy that the battery can provide.

In addition, the internal resistance of the battery grows, causing the output voltage to drop. 
