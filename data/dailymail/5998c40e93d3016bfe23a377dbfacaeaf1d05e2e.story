...
Step 1 and 2: Enter your message setting on your Samsung phone. Depending on what handset you have, the presentation of these options may vary

 

 Step 1: Enter your message icon

 Step 2: Select message settings

 

 

 Step 3: Scroll to Input mode

 Step 4: Select GSM alphabet
...
The word emoticon comes from emotion and icon

Also known as emojis, they are used to portray a texter's mood of feelings - and in the earliest form were produced by sending combinations of colons and brackets to create facial expressions.

Many smartphones now come with a vast collection of emoticon symbols, while apps containing thousands more can also be downloaded.

The current form of emoticons first rose to popularity in Japan. 
...
If you are on a monthly contract, the amount you pay for MMS messages will vary depending on what network you use. Here's what each major company charges:
...
'It’s worth noting that many of these smartphones/devices will alert customers when a SMS message is converting to an MMS message before it is sent.' 
