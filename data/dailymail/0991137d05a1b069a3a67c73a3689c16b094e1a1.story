...
Researchers Charles Henderson (right) and David Byrne (left) said a global maker of cash registers has been using the same default password on the payment devices for more than two decades. This potentailly puts the devices at risk of being a target of a security breach

'Nine out of 10 times when we see equipment from that manufacturer, 90 per cent of the time, this is the password,' he said.
...
Hackers would need physical access to the payment devices, opening a panel of the device using a paperclip, to exploit it, according to The Register. This type of attack is uncommon and reportedly easy for malicious staff.

For example, during the conference it was revealed that two individuals reportedly entered a major American retail store, unscrewed a server rack and walked out with the server leaving the store unable to process credit card payments, according to RT.

While Henderson and Byrne did not name the vendor using the 166816 password,  a Google search pointed to Verifone which connects around 27 million payment devices around the world, according to RT.
...
While Henderson and Byrne did not name the vendor, a Google search pointed to Verifone (file photo of one of the company's payment devices)

The company said: 'What the password allows someone to do is to configure some settings on the terminal; all executables have to be file signed, and it is not possible to enter malware just by knowing passwords.'
...
In another case of a security breach, in 2014, 56million debit and credit cards are estimated to have been breached in a data theft between April and September at Home Depot stores in the U.S. and Canada.

@highlight

Researchers  said during security conference that payment devices by unidentified global vendor came with password '166816'
