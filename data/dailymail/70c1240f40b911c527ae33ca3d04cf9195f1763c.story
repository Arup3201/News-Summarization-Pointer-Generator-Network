...
09:42 EST, 16 November 2013

Security footage obtained by NBC4 shows the terrifying moment 20-year-old Richard Shoop wielded a gun frightening shoppers in a New Jersey mall last week.

While Shoop didn't actually shoot any shoppers on November 5, the mall surveillance footage shows just how tense the situation was. Shoppers dodge into stores for protection as an all black-clad Shoop stalks the corridors.

Investigators said they don't believe Shoop intended to kill anyone and a note left by Shoop indicates that he  may have wanted to commit suicide.

Scroll down for video

Frightening: Footage obtained by NBC New York shows the night 20-year-old Richard Shoop terrified shoppers at a New Jersey mall with his AK-47-style gun

Hiding: Frightened shoppers ran into stores to hide from Shoop during his rampage last week

Suicide: Shoop died from a self-inflicted gun shot wound. Investigators believe he didn't intend to hurt anyone but himself

Walker: Shoop left a suicide note at his family's home before stealing his brother's gun

var nbcLP={};nbcLP.aRandomNumber=Math.floor(Math.random()*10000);nbcLP.currentPageLoc=encodeURIComponent(window.location.href);nbcLP.currentSiteLoc=encodeURIComponent(window.location.host);nbcLP.defaultWidth=652;nbcLP.defaultHeight=367;nbcLP.cmsID="232126881";nbcLP.vidPid="RCgzCP15jY5n";nbcLP.vidSec="TK";nbcLP.vidSubSec="TK";nbcLP.vidFrame=document.getElementById("nbcLP232126881");nbcLP.vidFrame.style.border="none";nbcLP.vidFrame.width=nbcLP.defaultWidth;nbcLP.vidFrame.height=nbcLP.defaultHeight;nbcLP.vidFrame.scrolling="no";nbcLP.vidFrame.src="http://www.nbcnewyork.com/templates/nbc_partner_player?cmsID="+nbcLP.cmsID+"&videoID="+nbcLP.vidPid+"&width="+nbcLP.defaultWidth+"&height="+nbcLP.defaultHeight+"&sec="+nbcLP.vidSec+"&subsec="+nbcLP.vidSubSec+"&turl="+nbcLP.currentSiteLoc+"&ourl="+nbcLP.currentPageLoc+"&rand="+nbcLP.aRandomNumber;
Relatives and friends of a young man struggled to 
reconcile those actions with a person they described as pleasant and 
well-liked.

'He told me that 
he was going to get a new job at this TV place and he was going to make 
good money,' said his childhood friend Madison Barbarini who happily 
posed for pictures with Shoop on her happy day in May 2011.
