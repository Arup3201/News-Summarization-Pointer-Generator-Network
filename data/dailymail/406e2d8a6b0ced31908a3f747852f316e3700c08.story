...
The new material in its liquid form (left) and the solid form it take on impact (right)

The liquid is called Shear-Thickening Fluid (STF), and  does not conform to the model of Newtonian liquids, such as water, in which the force required to move the fluid faster must increase exponentially, and its resistance to flow changes according to temperature.
...
Researchers have already tested the material in existing body armour designs.
