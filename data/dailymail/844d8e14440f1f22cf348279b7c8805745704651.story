...
To use the service, Nexus 6 owners must sign-up to request an invitation, must have a Gmail address, and must live in a US zip code within the coverage area. In this map, the dark green areas are covered by the service's 4G LT, the lime green is covered by 3G and the pale green by 2G

Verizon 4G LTE coverage is pictured for comparison. Project Fi will be hosted through Sprint Corp and T-Mobile's networks

The service will work only on the company's Nexus 6 phones and only in the US

Project Fi will be hosted through Sprint Corp and T-Mobile's networks. 

Overall, it costs $20 for basic service, which includes unlimited domestic talk, unlimited texting, tethering, and access in 120 countries. Customers pay $10 per GB of data.

Data is paid for in advance, and the cost of unused data gets refunded rather than rolled over or lost. 

Phone numbers will live in the cloud so that consumers can talk and text on any connected tablet.

Calls can be made via Hangouts on Android, iOS, and through Gmail on desktops, via the Hangouts widget. Texts can be made and received in the same way.

There is no annual service contract required when you sign up 

To use the service, Nexus 6 owners must sign-up to request an invitation, must have a Gmail address, and must live in a US zip code within the coverage area.

Google is promising Project Fi will automatically switch over to an available Wi-Fi network if that is running at a higher speed than the cellular alternatives.
...
Google has an incentive to promote cheaper and faster wireless service as a mobile virutal network operator. 

This is because it operates some of the world's most popular online services, including its search engine, maps, Gmail and YouTube video site. 

The Mountain View, California, company believes most people will visit those services more frequently if they are enticed to stay online for longer periods, giving Google more opportunities to show the digital ads that generate most of its revenue.

Similar motives prompted Google to begin building high-speed, hard-wired networks capable of navigating the Internet at speeds up to 100 times faster than existing broadband services.

Although Google is only selling its broadband service in a handful of U.S. cities so far, AT&T and Comcast are now offering options with comparable speeds in a few communities.

Price in Dollars: This graphic shows how much Google's new Project Fi will cost for various plans. For Talk and Text only, the Google carrier will cost $20 a month as compared to $35 for new partner TMobile. However the savings really start when 5GB of LTE is consider - with the Internet search giant's plan coming in at $70 and telecom giant Verizon's costing $110 a month

Project Fi initially will only be sold to a narrow US audience that owns the Nexus 6, a smartphone that Motorola Mobility made with Google's help
...
The invitation-only service will work only on Nexus 6 phones in the US  
