The Tennessee Supreme Court postponed execution dates for four inmates, effectively halting all executions while the courts decide whether current protocols for putting people to death are constitutional.
...
The Tennessee Supreme Court has vacated the execution dates of the last four men on the state's death row as new lethal injection methods are challenged. Above, electrocution has been designated as a backup method

Beginning in December 2013, the court set new execution dates for 11 inmates. 
...
Leroy Hall Jr, 48 (left) and Nicholas Todd Sutton, 53 (right) were both convicted of murder in 1991 and 1985, respectively. They no longer have dates for execution in Tennessee

Donald Strouth, 56 (left) and Abu-Ali Abdur'Rahman, 64 (right) were also both convicted of murder, though the European Union has called for Abdur'Rahman, who is believed to be mentally ill, to be allowed to live
...
The Tennessee Supreme Court's recent ruling will vacate the execution dates for Leroy Hall Jr, 48, Donald Wayne Strouth, 56, Nicholas Todd Sutton, 53, and Abu-Ali Abdur’Rahman, 64.
...
There are 69 people on Tennessee's death row. The Tennessee Supreme Court (pictured) is waiting for verdicts about the constitutionality of the lethal injection drug pentobarbital
...
Other states of the 31 with the death penalty are considering their own alternatives. Utah last month reinstated the firing squad as a backup method if it can't obtain lethal injection drugs. 

In Oklahoma, lawmakers approved nitrogen gas as a backup execution method. The state's Republican Governor Mary Fallin supports the death penalty but has not said whether she will sign the bill.
...
The US Supreme Court will hear a case later this month about the first substance in a so-called 'three drug cocktail', which is supposed to render the person being executed unconscious so they will not feel pain for the second two drugs.
...
Tennessee uses only one drug in its protocol, the sedative pentobarbital.

There are 69 people in death row in the state, according to the Department of Corrections. 

The Tennessee Supreme Court order said that their execution dates have previously been vacated for legal challenges.
