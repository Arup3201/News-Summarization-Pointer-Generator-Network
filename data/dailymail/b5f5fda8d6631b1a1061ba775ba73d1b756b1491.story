Flight cancellations soared by 20 per cent and delays by 7 per cent in the first quarter of 2015.
...
'For clarity, during the first quarter of 2015 we experienced winter weather across Europe which has been far worse than the same period last year, which particularly affected our operation to and from France, as well as the recent the French ATC strike which affected many carriers across Europe. It should be noted that during this time frame Monarch Airlines’ did not cancel any flights.
...
'Monarch Airlines will only cancel flights if there is absolutely no viable way of operating that flight thus placing the highest value on getting customers to their destination as opposed to protecting our on-time performance by tactically cancelling our flights.' 
...
Monarch Airlines contests the EUclaim figures, however, telling MailOnline Travel that 'their source of information is questionable.

'They claim that their data comes directly from the aircrafts on board ACARS and ADS-B systems, but Monarch Airlines use neither of these.
...
'We put our customers before our OTP and would rather operate with a delay than not at all.' 
