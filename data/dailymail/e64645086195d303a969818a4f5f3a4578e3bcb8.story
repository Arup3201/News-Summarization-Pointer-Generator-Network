...
06:32 EST, 16 October 2012

Apple, Microsoft and Amazon are set to go head to head in a unique battle for consumer's cash.

The tech giants are set to release tablets within days of each other later this month.

Apple is expected to launch its iPad mini on October 17th - a week before Amazon releases its tablets in the UK, and Microsoft releases its own Surface tablet.
...
Apple's iPad mini is expected to so on sale around the world on November 2nd, according to online speculation.
...
The gadgets, are available in both 7inch and 8.9inch versions (although only the 7inch version is currently set to go o sale outside of the US).

The third contender is Microsoft, with its Surface tablets.

The firm will launch the Surface tablet at the same time as Windows 8, the latest version of its desktop operating system, whcih experts say is a 'make or break' time for the firm.
...
Experts also believe that Amazon's Kindle, which is being launched outside the US for the first tim, could be let down if not enough content is available.
...
The iPad will continue to be the benchmark, the danger for Microsoft and Amazon is that people will ask 'can it do what an iPad does?'
...
Unprecedented timing will see three launches this month
