...
The research focused on POMC neurons, which are a structure called the hypothalamus, that send and receive signals to regulate appetite. On the left, images of normal hypothalamus POMC cells from a developing mouse. On the right: when the gene for the transcription factor is deleted, the cells no longer make it
...
The new findings show in animals that the same thing happens when certain genetic triggers inside the POMC cells aren't working.
...
That little voice inside your head that tells you to keep eating is, in fact, simply a cluster of around 10,000 brain cells. Now scientists believe they have found tiny triggers inside those cells that give rise to this 'voice'

'The POMC region is a central node of the brain's means for regulating body weight, in response to influences from the hormone leptin,' said Malcom Low, a professor in the Department of Molecular and Integrative Physiology.
...
The latest research show in animals that the same thing happens when certain genetic triggers inside the POMC cells aren't working.
...
Mice born without both of them became obese – as if their Pomc gene had been deactivated.
...
Looking to see if the same factors do the same thing in humans will be more complex – and there may be other enhancers and transcription factors involved.

But in theory, it could be possible to find drugs to increase the production of Pomc gene products, or to help silence it. 

'For humans, Pomc regulation may be part of the equation of weight control,' says Low. 'We don't know, but we think it likely, that it may be similar to the mouse model, where its role is like a dial, with a linear relationship between the amount of Pomc expression and the degree of obesity.'
