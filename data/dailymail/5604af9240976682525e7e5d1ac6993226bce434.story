Amazon is trialling a  scheme that could spell the end of waiting in for deliveries or collecting your parcels from a local locker.
...
Select Amazon Prime customers will soon be given the option to have their goods delivered to the boot, or trunk, of their car without needing to be near the vehicle. The pilot scheme is launching in Munich next month and Amazon has teamed up with Audi and DHL to run the initiative
...
As soon as the boot is closed the vehicle is locked automatically, and the code is revoked. 

Amazon said the vehicle can be parked anywhere  a delivery driver can access, including public car parks, but not gated properties. 
...
It said it is also looking into ways to extend the service to other Prime members with different vehicles in different regions.

'We are working to offer Prime members a delivery location that is always available and convenient: the trunk of their car,' explained Michael Pasch, European director of Amazon Prime.
...
Amazon is also planning to launch a drone delivery service in the UK, and already offers drop-offs to be made in Amazon Lockers. 

These lockers can be installed in various locations and shops within a town or city worldwide. 
