Google claims to have cracked a problem that has flummoxed anyone who has tried to read a doctor's note - how to read anyone's handwriting.
...
It even allows users to simply draw emoji they want to send. 
...
'Entering text on mobile devices is still considered inconvenient by many; touchscreen keyboards, although much improved over the years, require a lot of attention to hit the right buttons,' Google said.
...
Android handsets can understand handwriting in 82 languages in 20 distinct scripts
...
Google has announced a new tool that locates missing handsets simply by searching for the term 'find my phone' on the search engine's homepage (animated). It works with all Android phones that have the latest Google app installed and when the user is signed into their Google account on Chrome
...
Google Handwriting Input works on Android phones and tablets

@highlight

Handsets can under 82 languages in 20 distinct scripts

@highlight

Works with both printed and cursive writing input with or without a stylus 