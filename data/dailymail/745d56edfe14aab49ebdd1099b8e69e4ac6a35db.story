...
Researchers at the University of Washington studied the telerobot Raven II (shown). They found that robots designed for surgery could be 'easily' hacked in to. This is because they are operated over public networks which allowed the researchers to access them and stop them working
...
The first telesurgery took place in 2001 with a surgeon in New York successfully removing the gall bladder of a patient in France, more than 3,730 miles (6,000km) away.
...
While this experiment was performed in a controlled environment and not on the operating table (stock image pictured), the researchers said it is clear more stringent security measures are needed

During the experiment, an operator was asked to move blocks onto different pegs (shown) with the robot, but when the 'hackers' took control, the task proved difficult - or impossible 
