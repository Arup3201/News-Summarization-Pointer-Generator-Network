...
It's long been known that earthquakes contribute to making the Earth ring like a bell, but researchers have now proved ocean waves also play a role. As  short waves collide near the surface they create weak microseismic waves, which combine with long waves on the ocean's floor to create a constant hum

Earthquakes shake the planet in such a way that the Earth can oscillate for months after the seismic event. 

This oscillation is caused by vibrations and researchers in the mid-1980s found the hum can drop as low as an E flat, 20 octaves below middle C on the musical scale.

In the late 1990s, however, seismologists found that the planet doesn't just oscillate following quakes, and instead is vibrating at extremely low frequencies all of the time. 
...
A team of Japanese and Californian seismologists first suggested ocean waves may cause this constant hum in 2004. 
...
During March 2008 two large seismic events took place. But the largest hum  coincided with a Johanna storm (right). The storm generated waves with a peak of 16 seconds and heights of 42ft (12.8 metres) (left). From this, the team could conclude the hum was caused by the storm, and not leftover from the seismic events

Using seismic readings from 2008, a French team spotted that ocean waves colliding generate seismic activity, but these waves only take 13 seconds to complete a single oscillation. They didn't explain why slow seismic waves - which provide the most powerful bell-like ringing - can last for longer than 50 seconds
...
Using the 2008 data, Mr Ardhuin and his team spotted that ocean waves colliding generate seismic activity, but these waves only take 13 seconds or less to complete a single oscillation.

The team then studied ocean waves at the bottom of the seabed. As these so-called long waves travel over the ocean floor (stock image) and continental shelves they create seismic waves that oscillate much slower. This means that earthquakes, colliding oceans and long waves all combine to create the Earth's hum
...
Stronger seismic waves then occurs when water travels along the floor