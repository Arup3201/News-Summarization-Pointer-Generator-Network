...
The device fits invisibly into the wheel of a trolley and is fitted with with sensors and Bluetooth connection. It was invented by product design firm Cambridge Consultants.

It tells retailers a shopper’s location to within 3ft (one metre) and doesn’t need batteries because it harvests energy from the rotation of the wheel to power the technology.

Data is transmitted via Bluetooth to a shop’s server, meaning the system would be relatively cheap to put in place.

The technology may spell the end of queues because it could be used to alert staff when customers are nearing checkouts, allowing shops to automatically allocate assistants when they are needed most.

It could also point consumers in the right direction to find special offers.
