...
Convenient: The Salt card (pictured) is designed to end the tiresome task of manually unlocking a smartphone or tablet, by automatically unlocking it whenever the user is nearby
...
The credit card-sized gadget (illustrated) also locks devices again as soon as a user moves out of range. It connects to an app on a user’s Android handset or iPhone via Bluetooth and also tells them if they have strayed too far from their wallet, where it is suggested the Salt card is stored

The start-up claims that its Salt card is more secure than fingerprint scanners, such as the one in Apple's iPhone 6 handset (pictured) and it can be used with gloves in the winter
...
This not only makes it more accurate than other sensors, but it will also work even if the user’s hands are wet or have dirt or lotions on it, for example.
...
It is claimed that the card  will save people around 53 hours over a year, based on the time it takes to type a password into their phone 150 times a day
...
'One day we'd like the card to communicate with doors, unlocking as you approach them, lights turning on and off or you walk into a restaurant and you won't need to let them know you've arrived, it'll just book you in, Mr Paglione said.

There are already key fobs that can unlock handsets and many people no longer input a PIN, instead using biometric technology such as fingerprint scanners and iris scanners (illustrated) to unlock their smartphones
...
The pattern doesn’t change significantly after the age of two, and it is difficult to injure its surface and difficult to forge.
