The battle of the batteries is hotting up.
...
Mr Barr explained that Dr. Bhardwaj recently described how 'solid-state, thin-film batteries could be used in smartphones and other mobile devices that are thinner, bendable, wearable and even implantable in the human body.' 

He also referenced a video for Project Loon that revealed how Google has been working with experts at AllCell Technologies to develop batteries that function at subfreezing temperatures. 
...
Fan site AppleInsider recently spotted nine job listings on Apple's official recruitment site in the past month that relate to batteries. These include one for an iOS battery life software engineer (pictured left) and another for iOS software power systems engineer (pictured right)

The AllCell technology uses wax and a graphite material, for example, to help lithium-ion batteries absorb heat and spread it across the power pack.
...
It is said to be the first high-performance aluminium battery which is 'fast-charging, long-lasting and inexpensive' and is more environmentally friendly than alkaline batteries. 

It also can't catch fire like lithium-ion technology.
...
And Google isn't the only tech giant working on such plans. 
...
A team of Stanford University chemists recently unveiled an aluminium battery that can fully recharge in less than 60 seconds. It is said to be the first high-performance aluminium battery which is 'fast-charging, long-lasting and inexpensive' and is more environmentally friendly than alkaline batteries

Last month, Atmel released its latest microcontrollers (MCUs) for a variety of gadgets that are so low power they can even harvest energy from a person's body. Atmel said its MCUs extend 'battery life from years to decades, reducing the number of times batteries need to be changed in devices'
...
Reports claim Google is latest firm to test alternative battery options
